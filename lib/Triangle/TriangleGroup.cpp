...
TriangleGroup::TriangleGroup(Vector3D* vertices, IndexGroup* indexGroup, int vertexCount, int triangleCount) : vertexCount(vertexCount), triangleCount(triangleCount) {
...
TriangleGroup::TriangleGroup(Vector3D* vertices, IndexGroup* indexGroup, IndexGroup* uvIndexGroup, Vector2D* uvVertices, int vertexCount, int triangleCount, int uvVertexCount) : vertexCount(vertexCount), triangleCount(triangleCount), uvVertexCount(uvVertexCount) {
	this->vertices = vertices;
	this->indexGroup = indexGroup;
...
TriangleGroup::TriangleGroup(TriangleGroup* triangleGroup) : vertexCount(triangleGroup->GetVertexCount()), triangleCount(triangleGroup->GetTriangleCount()) {
